...
class Gen_compressed(threading.Thread):
  ...
  def do_compile_local(self, params, target_filename):
      ...
      dash_params = [("--" + arg, value) if arg != "js_file" else (value,) for (arg, value) in params]
      dash_args = [item for pair in dash_params if pair[0][2:] not in filter_keys for item in pair]
      args = [item for group in [["google-closure-compiler"], dash_args] for item in group if item]
